            ...
            <div className='infor_main'>
                <nav className="breadcrumb-container">
                    <div className="breadcrumb-content">
                        ...
                        <div className="breadcrumb-path">
                            ...
                            <span className="separator">Specialist examination</span>
                            <span className="separator">/</span>
                            <span className="current-page">{data.specialty}</span>
                            <span className="separator">/</span>
                            <span className="current-page">{data.position},{data.name}</span>
                        </div>
                    </div>
                </nav>
                ...
                <div className='slider-doctor'>
                    <div className='doctor_container'>
                        <img src={data.image} alt={data.name} className='doctor-slider' />
                    </div>
                    <div className='doctor_information'>
                        <h1 className='user_doctor'>{data.position} {data.name}</h1>

                        <p className='doctor-summary'>
                            {data.practical_experience}
                        </p>
